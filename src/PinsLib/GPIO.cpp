...
namespace PinsLib {
     ...
     */
    GPIO::GPIO(int number) : Pins(number, GPIO_EXPORT_PATH) {
        this->debounceTime = 0;
    ...
    int GPIO::setDirection(GPIO_DIRECTION dir){
       switch(dir){
       case INPUT: return this->write("direction", "in");
          break;
       case OUTPUT:return this->write("direction", "out");
          break;
       }
       return -1;
    }
    ...
    int GPIO::setEdgeType(GPIO_EDGE value){
       switch(value){
       case NONE: return this->write("edge", "none");
          break;
       case RISING: return this->write("edge", "rising");
          break;
       case FALLING: return this->write("edge", "falling");
          break;
       case BOTH: return this->write("edge", "both");
          break;
       }
       return -1;
    }
    ...
    int GPIO::setActiveLow(bool isLow){
       if(isLow) return this->write("active_low", "1");
       else return this->write("active_low", "0");
    }
